...
class pizzaChart extends StatefulWidget {
  @override
  _charttt2State createState() => _charttt2State();
}

class _charttt2State extends State<pizzaChart> {
  int positive = 0;
  int neutral = 0;
  int negative = 0;
  ...
  Future<void> fetchSentimentData() async {
    // Update URL for Pizza sentiment data
    final response = await http.get(Uri.parse('${Url.Urls}/owner/pizza'));
              ...
              children: [
                ...
                Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/pizza.jpg',  // Replace with your pizza image path
                      width: 300,
                      height: 200,
                      fit: BoxFit.cover,
                    ),
