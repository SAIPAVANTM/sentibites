...
class dosaChart extends StatefulWidget {
  @override
  _charttt5State createState() => _charttt5State();
}

class _charttt5State extends State<dosaChart> {
  int positive = 0;
  int neutral = 0;
  int negative = 0;
  ...
  Future<void> fetchSentimentData() async {
    // Update URL for Dosa sentiment data
    final response = await http.get(Uri.parse('${Url.Urls}/owner/dosa'));
              ...
              children: [
                ...
                Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/dosa.jpg',  // Replace with your dosa image path
                      width: 300,
                      height: 200,
                      fit: BoxFit.cover,
                    ),
