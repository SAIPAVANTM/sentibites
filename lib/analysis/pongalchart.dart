...
class pongalChart extends StatefulWidget {
  @override
  _charttt4State createState() => _charttt4State();
}

class _charttt4State extends State<pongalChart> {
  int positive = 0;
  int neutral = 0;
  int negative = 0;
  ...
  Future<void> fetchSentimentData() async {
    // Update URL for Pongal sentiment data
    final response = await http.get(Uri.parse('${Url.Urls}/owner/pongal'));
              ...
              children: [
                ...
                Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/pongal.jpg',  // Replace with your pongal image path
                      width: 300,
                      height: 200,
                      fit: BoxFit.cover,
                    ),
