...
class charttt1 extends StatefulWidget {
  @override
  _charttt1State createState() => _charttt1State();
}

class _charttt1State extends State<charttt1> {
  int positive = 0;
  int neutral = 0;
  int negative = 0;
  ...
  Future<void> fetchSentimentData() async {
    final response = await http.get(Uri.parse('${Url.Urls}/owner/mexican'));
              ...
              children: [
                ...
                Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/f1.png',  // Replace with your image path
                      width: 300,
                      height: 200,
                      fit: BoxFit.cover,
                    ),
