...
class burgerchart extends StatefulWidget {
  @override
  _charttt1State createState() => _charttt1State();
}

class _charttt1State extends State<burgerchart> {
  int positive = 0;
  int neutral = 0;
  int negative = 0;
  ...
  Future<void> fetchSentimentData() async {
    // Update URL for Burger sentiment data
    final response = await http.get(Uri.parse('${Url.Urls}/owner/burger'));
              ...
              children: [
                ...
                Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/burger.jpg',  // Replace with your burger image path
                      width: 300,
                      height: 200,
                      fit: BoxFit.cover,
                    ),
